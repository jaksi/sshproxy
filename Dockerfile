...
RUN mkdir /run/sshd
EXPOSE 2022
CMD /usr/sbin/sshd && /sshproxy -listen :2022 -hostkeys /etc/ssh/ssh_host_rsa_key,/etc/ssh/ssh_host_ecdsa_key,/etc/ssh/ssh_host_ed25519_key -connect localhost:22 -user user -password hunter2 -json
